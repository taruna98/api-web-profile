...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_FILES['portfolio_file_2']) && $_FILES['portfolio_file_2']['error'] === UPLOAD_ERR_OK) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_FILES['portfolio_file_3']) && $_FILES['portfolio_file_3']['error'] === UPLOAD_ERR_OK) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_FILES['portfolio_file_4']) && $_FILES['portfolio_file_4']['error'] === UPLOAD_ERR_OK) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_FILES['portfolio_file_5']) && $_FILES['portfolio_file_5']['error'] === UPLOAD_ERR_OK) {
